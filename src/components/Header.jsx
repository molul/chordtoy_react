...
const Header = () => {
  ...
  return (
    <>
      <div className="z-50 font-toyBox tracking-wide bg-mainBlue uppercase mb-2 text-4xl md:text-5xl w-full text-white flex items-center flex-row justify-center h-16 px-2">
